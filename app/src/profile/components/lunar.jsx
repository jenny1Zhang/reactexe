...
//			            m,
//			            this.chineseNumber(e-1)); //天干地支年 生肖年 月份 日
//			    lunarArray.push(leapMonth); //闰几月
//			    return lunarArray;
				return this.lunarYear(year)+'年'+m+this.chineseNumber(e-1)
			  },
			  //中文月份
    ...
    if(dateString){
      ...
      var lunar = Lunar.toLunar(dateString[0],dateString[1],dateString[2]);
      console.log(lunar)
      this.setState({outLunar: lunar})
    }else{
      this.setState({outLunar: ''})
    }
    ...
    return (
      <div style={{marginTop:80}}>
        <Row type="flex" justify="center">
          <Col span={7}>
            <label style={{fontSize:14}}>请输入阳历日期：&nbsp;&nbsp;</label>
            <DatePicker onChange={this.dateChange} />
          </Col>
          <Col span={8}>
            <Input addonBefore="转换后的农历日期：" value={this.state.outLunar} id="blue"/>
          </Col>
        </Row>
      </div>
    )
