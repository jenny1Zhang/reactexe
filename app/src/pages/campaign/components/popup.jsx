            ...
            <div>
                ...
                <Modal title="新建广告系列" visible={this.state.visible} onOk={this.handleSubmit} onCancel={this.handleCancel}>
                    <Form>
                        ...
                        {getFieldDecorator('planName')(<Input type="text" />)}
                        </FormItem>
                        ...
                        <FormItem {...formItemLayout} label="推广品牌车型：">
                            {getFieldDecorator('carType')(<Cascader options={areaData} />)}

                        </FormItem>
                        <FormItem {...formItemLayout} label="设定投放限额：">
                            {getFieldDecorator('limit')(<InputNumber min={50} max={4000000} />)}元/天
                        </FormItem>
                        <FormItem {...formItemLayout}
                            ...
                            {getFieldDecorator('line')(<Switch checkedChildren="开" unCheckedChildren="关" />)}
                        </FormItem>
                    </Form>
                </Modal>
            </div>
